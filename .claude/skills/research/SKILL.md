...
创建/更新 `Knowledge Base/[主题]/progress.txt`：
...
| 文件 | 路径 |
|------|------|
| 主文档 | `Knowledge Base/[主题]/[主题名] 核心知识体系.md` |
| 大纲 | `Knowledge Base/[主题]/outline.md` |
| 进度 | `Knowledge Base/[主题]/progress.txt` |
...
预计：45-60 分钟  |  存储：Knowledge Base/React/...
...
*Skill 版本：3.1.1 | 作者：Kei | 更新：2026-03-25*
*更新说明：添加 MCP WebSearch 优先规则，禁止使用原生 WebSearch*
